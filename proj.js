...
intentMap.set("Default Welcome Intent - yes - custom", identify_user);
intentMap.set("Default Welcome Intent - yes - custom - custom - custom", report_issue);
intentMap.set("Default Welcome Intent - yes - custom - custom", custom_payload);
